...
from chat_service.models import Room, Message
...
class ChatConsumer(AsyncJsonWebsocketConsumer):
	...
	async def send_message(self, data):
		logging.info(f'sending a message')
		...
		try:
			...
			logging.info(f'sending message to group: {message_data}')
			await self.channel_layer.group_send(
				f'chat_{room_id}',
				message_data
			)

			logging.info(f'message sent to all')
